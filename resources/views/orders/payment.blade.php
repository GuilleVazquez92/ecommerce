                ...
                <div class="flex justify-between items-center">
                    ...
                    <div class="text-gray-700">
                        <p class="text-sm font-semibold">
                            Subtotal: {{$order->total - $order->shipping_cost}} Gs
                        </p>
                        <p class="text-sm font-semibold">
                            Envio: {{$order->shipping_cost}} Gs
                        </p>
                        ...
                        <button type="submit" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">PAGAR</button>
